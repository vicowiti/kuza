...
const navigation = {
    ...
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/KuzaTrust',
            icon: (props: any) => (
        ...
        {
            name: 'Instagram',
            href: 'https://instagram.com/kuzatrust?igshid=YWYwM2I1ZDdmOQ==',
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        {
            name: 'Twitter',
            href: 'https://x.com/KuzaTrust?s=20',
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export default function Footer() {
    return (
        <footer id="footer" className="bg-gray-900" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
                ...
                <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
                    ...
                    <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
                        &copy; {new Date().getFullYear()} Kuza Trust. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
